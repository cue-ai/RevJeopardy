...
export const additionalFinalRoundQuestions: Question[] = [
    {
        ...
        answer: "Prospecting",
        answers: ["Lead Generation", "Networking", "Prospecting"],
        value: 2000,
        numAttempts: 0,
        numCorrect: 0,
        category: "Sales",
    },
    {
        ...
        answers: ["Affiliate Marketing", "Influencer Marketing", "Content Marketing"],
        value: 2000,
        numAttempts: 0,
        numCorrect: 0,
        category: "Marketing",
    },
    {
        ...
        answer: "Churn Rate",
        answers: ["Retention Rate", "Acquisition Rate", "Churn Rate"],
        value: 2000,
        numAttempts: 0,
        numCorrect: 0,
    ...
    },
    {
        ...
        answers: ["Balance Sheet", "Cash Flow Statement", "Income Statement"],
        value: 2000,
        numAttempts: 0,
        numCorrect: 0,
        category: "Finance",
    },
    {
        ...
        answer: "Correlation",
        answers: ["Regression", "Standard Deviation", "Correlation"],
        value: 2000,
        numAttempts: 0,
        numCorrect: 0,
